...
<div class="content-wrapper">
	...
	<div class="stunning-header stunning-header-bg-green">
		<div class="stunning-header-content">
			<h1 class="stunning-header-title">Academic Content</h1>
			<ul class="breadcrumbs">
				...
				<li class="breadcrumbs-item active">
					<span href="#">Academic Content</span>
					<i class="seoicon-right-arrow"></i>
				</li>
			</ul>
		</div>
	...
	<div class="container">
		<div class="row medium-padding120">
			...
			<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
				<h5 class="mb30">We have one of the biggest teams of subject-matter experts, who are specialised in their subjects and have experience in the field of academic content creation. </h5>
				<p>
                We cover multiple different subject areas such as Management, Finance, Nursing, Psychology, Law and more. If you need a solution for your academic project in any of the subjects mentioned earlier, just contact us. Our academic content services also include revisions and Redo for free. Share your assignment brief and your needs in detail for getting a quotation. Once, you make up your mind confirm your order and rest assured, you just have to wait till the results come. 
				</p>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row medium-padding120">
			<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
				<div class="heading">
					<h4 class="h1 heading-title">See How Our
						Experts Solve All Your Questions.</h4>
			...
			<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
				...
				<form class="contact-form crumina-submit" data-nonce="crumina-submit-form-nonce" data-type="standard" action="modules/forms/submit.php">
					...
					<div class="row">
						...
						<input name="file" class="input-standard-grey" type="file">
						</div>
					</div>
