				...
				<div class="row">
					...
					<div class="subscribe scrollme">
						...
						<div class="col-lg-6 col-lg-offset-5 col-md-6 col-md-offset-5 col-sm-12 col-xs-12">
							<h4 class="subscribe-title">Build your career with us!</h4>
							<form class="subscribe-form crumina-submit" method="post" data-nonce="crumina-submit-form-nonce" data-type="standard" action="modules/forms/submit.php">
								<input class="input-standard-grey input-white" name="email" placeholder="Your Mobile Number" type="email" required>
								<button class="subscr-btn">enroll
		...
		<div class="row">
			...
			<div class="info">
				<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
					<div class="heading">
					<img loading="lazy" width="200" src="img/logo-eye-light.png" alt="GlobalProbes">
						<div class="heading-line">
							<span class="short-line"></span>
							<span class="long-line"></span>
						</div>
						<p class="heading-text">Designed to provide best content writing services
						</p>
					</div>
				...
				<div class="col-lg-4 col-lg-offset-1 col-md-4 col-md-offset-1 col-sm-12 col-xs-12">
					<div class="services">
						<div class="heading">
							<h3 class="heading-title">Services We Deliver</h3>
							<div class="heading-line">
								<span class="short-line"></span>
								<span class="long-line"></span>
							</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <span>
                        Copyright © 2023 <a href="index.html" class="sub-footer__link">GlobalProbes,</a>
                        Designed by <a href="">codemodebharat@gmail.com</a>
                    </span>

					<span>Developed by <a href="">CodeMode Team</a></span>
					<span>Only on <a href="">Web</a></span>
