		...
		<div class="row">
			...
			<div class="info">
				<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
					<div class="heading">
						<h3 class="heading-title">CodeMode!</h3>
						<div class="heading-line">
							<span class="short-line"></span>
							<span class="long-line"></span>
						</div>
						<p class="heading-text">Designed to launch your career
						</p>
					</div>
				...
				<div class="col-lg-4 col-lg-offset-1 col-md-4 col-md-offset-1 col-sm-12 col-xs-12">
					<div class="services">
						<div class="heading">
							<h3 class="heading-title">Courses Provided</h3>
							<div class="heading-line">
								<span class="short-line"></span>
								<span class="long-line"></span>
							</div>
				...
				<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
					<div class="contacts-item">
						...
						<div class="content">
							...
							<p class="sub-title">New Town, Action Area - 3</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <span>
                        Copyright © 2023 <a href="index.html" class="sub-footer__link">CodeMode,</a>
                        Designed by <a href="https://themeforest.net/user/themefire/portfolio">codemodebharat@gmail.com</a>
                    </span>

					<span>Developed by <a href="https://themeforest.net/user/crumina/portfolio">CodeMode Team</a></span>
					<span>Only on <a href="https://themeforest.net/user/crumina/portfolio">Web</a></span>
